// Form constants for BusinessForm
export const categories = ['Automobile', 'Technology', 'Retail', 'Finance', 'Healthcare', 'Education', 'Manufacturing', 'Other'];
...
export const participantTitles = ['Member', 'Manager', 'President', 'Secretary', 'Treasurer'];
